...
using System;
using Openmiracle.MiracleIChart.Common.UndoSystem;
	...
	public class KeyboardNavigation : IPlotterElement
	{
		...
		private void ShowHelpExecute(object target, ExecutedRoutedEventArgs e)
		{
			if (!aboutWindowOpened)
			{
				...
				//            string helpText =
				//@"Miracle I is in ""Auto Fit"" mode by default.
				...
				//            MessageBox.Show(helpText, "MiracleIChart Quick Help", MessageBoxButton.OK, MessageBoxImage.Information);
