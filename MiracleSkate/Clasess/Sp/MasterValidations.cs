...
namespace MiracleSkate
{
    class MasterValidations : Checkings
    {
        ...
        internal System.Windows.Media.Brush LedgerValidations(LedgerInfo accountLedgerinfo, out string toolTip)
        {
            if (accountLedgerinfo.Name != string.Empty && accountLedgerinfo.Name != null)
            {
                if (!CheckAccountLedgerExist(accountLedgerinfo.Name))
                {
                    ...
                    {
                        toolTip = "Account group does not belong to Openmiracle, Add Account group first.";
        ...
        internal bool SavingValidation_AccountingLedger(AccountLedgerInfoforOpenmiracle infoAccountLedger)
        {
            ...
            if (accountgroupinfo.Name != string.Empty && accountgroupinfo.Name != null)
            {
                if (accountgroupinfo.Under != string.Empty && accountgroupinfo.Under != null)
                {
                    if (!CheckAccountGroupExist(accountgroupinfo.Name))
                    {
                        ...
                        {
                            toolTip = "Nature does not exist because Account group under does not belong to Openmiracle,Repeated clicking on the skate button,may catches the Nature.";
                            return System.Windows.Media.Brushes.Orange;
                        }
                    }
                    else
        ...
        internal bool SavingValidation_AccountingGroup(AccountGroupInfoforOpenmiracle infoAccountGroup)
        {
 ...
 (Convert.ToDecimal(productinfo.PurchaseRate) >= 0) &&
  ...
  (bool.TryParse(productinfo.OpeningStock, out isT)));
        ...
        internal bool SavingValidation_Product(ProductInfofroOpenmiracle infoProduct)
        {
        ...
        internal bool SavingValidation_PricingLevel(PriceLevelInfofroOpenmiracle infoPricingLevel)
        {
        ...
        internal bool SavingValidation_ProductGroup(ProductGroupinfoforOpenmiracle ProductGroupinfoforOpenmiracle)
        {
            return (ProductGroupinfoforOpenmiracle.GroupName != "" && ProductGroupinfoforOpenmiracle.GroupUnder != -1 && ProductGroupinfoforOpenmiracle.GroupName != null && !CheckProductGroupExist((ProductGroupinfoforOpenmiracle.GroupName)));
        }
        ...
        internal bool SavingValidation_Unit(UnitinfoforOpenmiracle infoUnit)
        {
        ...
        internal bool SavingValidation_Godown(GodowninfoforOpenmiracle item)
        {
...
&& decimal.TryParse(Stock.ClosingRate, out isD));
        ...
        internal bool SavingValidation_Stock(StockforOpenmiracle infoProduct)
        {
        ...
        internal bool SavingValidation_Currency(CurrencyInfoforOpenmiracle item)
        {
                        ...
                        if (vouchertype.methodOfVoucherNumbering != null && vouchertype.methodOfVoucherNumbering != string.Empty)
                        {
                            if (vouchertype.dotMatrixPrintFormat != null && vouchertype.dotMatrixPrintFormat != string.Empty)
                            {
                                if (CheckTypeofVoucherExists(vouchertype.typeOfVoucher))
                                {
                                    ...
                                    {
                                        toolTip = "Sorry!, Type of printing format not match with Openmiracle.";
                                        return System.Windows.Media.Brushes.Orange;
                                    }
                                }
                                else
                                {
                                    toolTip = "Sorry!, Type of voucher not match with Openmiracle";
                                    return System.Windows.Media.Brushes.Orange;
                                }
                            }
                            else
        ...
        internal bool SavingValidation_VoucherType(VoucherTypeinfoforOpenmiracle infoVoucherType)
        {
