...
{
    class Openmiracle : MasterValidations
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void AddAccountLedger(List<AccountLedgerInfoforOpenmiracle> lstinfoAccountLedger, ref string Mess, System.Windows.Controls.Label Message)
        {
            int Skated = 0;
            decimal decMainIdLed = 0;
            foreach (AccountLedgerInfoforOpenmiracle infoAccountLedger in lstinfoAccountLedger)
            {
                try
                {
        ...
        public void AddAccountGroup(List<AccountGroupInfoforOpenmiracle> lstinfoAccountGroup, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (AccountGroupInfoforOpenmiracle infoAccountGroup in lstinfoAccountGroup)
            {
                try
                {
        ...
        /// <returns></returns>
        public void AddProduct(List<ProductInfofroOpenmiracle> lstProduct, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            try
            {
                foreach (ProductInfofroOpenmiracle infoProduct in lstProduct)
                {
        ...
        internal void AddPriceLevel(List<PriceLevelInfofroOpenmiracle> lstObjPriceLevel, ref string Mess, System.Windows.Controls.Label Message)
        {
            int Skated = 0;
            foreach (PriceLevelInfofroOpenmiracle infoPricingLevel in lstObjPriceLevel)
            {
                try
                {
        ...
        internal void AddProductGroup(List<ProductGroupinfoforOpenmiracle> lstObjProductGroup, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (var ProductGroupinfoforOpenmiracle in lstObjProductGroup)
            {
                try
                {
                    if (SavingValidation_ProductGroup(ProductGroupinfoforOpenmiracle))
                    {
                        functionConnectionState();
                        SqlCommand sqlcmd = new SqlCommand("ProductGroupAdd", sqlcon);
                        sqlcmd.CommandType = CommandType.StoredProcedure;
                        sqlcmd.Parameters.Add("@groupName", SqlDbType.VarChar).Value = ProductGroupinfoforOpenmiracle.GroupName;
                        sqlcmd.Parameters.Add("@groupUnder", SqlDbType.Decimal).Value = ProductGroupinfoforOpenmiracle.GroupUnder;
                        sqlcmd.Parameters.Add("@narration", SqlDbType.VarChar).Value = ProductGroupinfoforOpenmiracle.Narration;
                        sqlcmd.Parameters.Add("@extra1", SqlDbType.VarChar).Value = string.Empty;
                        sqlcmd.Parameters.Add("@extra2", SqlDbType.VarChar).Value = string.Empty;
                        sqlcmd.ExecuteScalar();
                        sqlcon.Close();
        ...
        internal void AddUnit(List<UnitinfoforOpenmiracle> lstObjUnit, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (UnitinfoforOpenmiracle infoUnit in lstObjUnit)
            {
                try
                {
        ...
        internal void AddGodwn(List<GodowninfoforOpenmiracle> lstObjGodowns, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (GodowninfoforOpenmiracle item in lstObjGodowns)
            {
                try
                {
        ...
        internal void AddStock(List<StockforOpenmiracle> lstObjStock, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (StockforOpenmiracle infoProduct in lstObjStock)
            {
                try
                {
        ...
        internal void AddCurrency(List<CurrencyInfoforOpenmiracle> lstObjCurrency, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (CurrencyInfoforOpenmiracle item in lstObjCurrency)
            {
                try
                {
        ...
        internal void AddVoucherType(List<VoucherTypeinfoforOpenmiracle> lstObjVoucherType, ref string Mess, System.Windows.Controls.Label Message)
        {

            int Skated = 0;
            foreach (VoucherTypeinfoforOpenmiracle infoVoucherType in lstObjVoucherType)
            {
                try
                {
