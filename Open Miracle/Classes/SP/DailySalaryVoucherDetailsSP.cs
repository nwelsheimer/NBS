...
{
    class DailySalaryVoucherDetailsSP : DBConnection
    {
        #region Function
        /// <summary>
        ...
        public DataTable DailySalaryVoucherDetailsGridViewAll(string strSalaryDate, bool isEditMode, string strVoucherNumber)
        {
            ...
            dtblDailySalaryVoucherDetailsGridViewAll.Columns["Sl.No"].AutoIncrementSeed = 1;
            dtblDailySalaryVoucherDetailsGridViewAll.Columns["Sl.No"].AutoIncrementStep = 1;
            try
            {
                if (isEditMode == true)
                {
