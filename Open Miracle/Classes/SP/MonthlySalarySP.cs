...
{
    class MonthlySalarySP : DBConnection
    {
        #region Function
        /// <summary>
       ...
       /// <returns></returns>
        ...
        /// <returns></returns>
        public DataTable MonthlySalryViewAllForMonthlySalaryReports(DateTime dtpFromDate,DateTime dtpToDate,string strDesignation,string strEmployeeCode,DateTime dtpSalaryMonth)//Coded By Swafiyy
        {
            ...
            dtblMonthlySalry.Columns["SlNo"].AutoIncrementSeed = 1;
            dtblMonthlySalry.Columns["SlNo"].AutoIncrementStep = 1;
            try
            {
