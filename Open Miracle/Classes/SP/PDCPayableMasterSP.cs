...
{
    class PDCPayableMasterSP : DBConnection
    {
        #region Function
        /// <summary>
       ...
       /// <returns></returns>
        ...
        /// <returns></returns>
        public DataTable ChequeReportGridFill(decimal decParty, string strChequeNo, DateTime dtFromDate, DateTime dtTodate, DateTime dtChequefromDate, DateTime dtChequetoDate, bool isIssued)    //, decimal decCurrencyId)
        {
            DataTable dtbl = new DataTable();
            dtbl.Columns.Add("SlNo", typeof(decimal));
            dtbl.Columns["SlNo"].AutoIncrement = true;
