...
{
    class PurchaseMasterSP : DBConnection
    {
        #region Function
        /// <summary>
        ...
        /// <returns></returns>
        public DataTable PurchaseInvoiceRegisterFill(string strColumn, DateTime dtFromDate, DateTime dtToDate, decimal decLedgerId, string strPurchaseMode,
        ...
        /// <returns></returns>
        public DataTable PurchaseInvoiceReportFill(decimal decCompanyId, string strColumn, DateTime dtFromDate, DateTime dtToDate, decimal decLedgerId, string strStatus,
