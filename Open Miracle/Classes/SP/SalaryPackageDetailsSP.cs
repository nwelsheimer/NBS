...
{
    class SalaryPackageDetailsSP : DBConnection
    {
        #region Function
        /// <summary>
        ...
        public DataTable SalaryPackageDetailsViewWithSalaryPackageId(decimal decSalaryPackageId)
        {
            ...
            dtblSalaryPackageDetails.Columns["SL.NO"].AutoIncrementSeed = 1;
            dtblSalaryPackageDetails.Columns["SL.NO"].AutoIncrementStep = 1;
            try
            {
                if (sqlcon.State == ConnectionState.Closed)
                {
        ...
        /// <returns></returns>
        public DataTable SalaryPackageDetailsForSalaryPackageDetailsReport(string strPackageName)//Coded By Swafiyy
        {
            DataTable dtblSalaryPackageDetails = new DataTable();
            dtblSalaryPackageDetails.Columns.Add("SlNo", typeof(int));
            dtblSalaryPackageDetails.Columns["SlNo"].AutoIncrement = true;
            dtblSalaryPackageDetails.Columns["SlNo"].AutoIncrementSeed = 1;
            dtblSalaryPackageDetails.Columns["SlNo"].AutoIncrementStep = 1;
            try
            {
