    ...
    public partial class frmCompanyCreation : Form
    {
        ...
        public void GetDefaultImage()
        {
            try
            {
                ...
                logo = (byte[])converter.ConvertTo(Open_Miracle.Properties.Resources.images, typeof(byte[]));
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                if (File.Exists(ApplicationPath + "\\Data\\COMP\\DBOpenmiracle.mdf") && File.Exists(ApplicationPath + "\\Data\\COMP\\DBOpenmiracle_log.ldf"))
                {
                    ...
                    if (!infoDirectory.Exists)
                    {
                        ...
                        File.Copy(ApplicationPath + "\\Data\\COMP\\DBOpenmiracle.mdf", infoDirectory.FullName + "\\DBOpenmiracle.mdf");
                        File.Copy(ApplicationPath + "\\Data\\COMP\\DBOpenmiracle_log.ldf", infoDirectory.FullName + "\\DBOpenmiracle_log.ldf");
