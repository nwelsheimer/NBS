...
namespace Open_Miracle
{
    public partial class frmCashFlow : Form
    {
        ...
        public void Clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF2:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public DataTable GetDataTable()
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF3:" + ex.Message;
            }
            return dtblCashflow;
        }
        /// <summary>
        ...
        public void Print(DateTime fromDate, DateTime toDate)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF5:" + ex.Message;
            }
        }
        #endregion
        #region Events
        ...
        private void frmCashFlow_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF6:" + ex.Message;
            }
        }
        /// <summary>
        /// Date Validation
        ...
        private void txtFromDate_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF7:" + ex.Message;
            }
        }
        /// <summary>
        /// Date validation
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF9:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF10:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF11:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmCashFlow_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "CF13:" + ex.Message;
            }
        }
        private void dtpFromDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF14:" + ex.Message;
            }
        }
        private void dtpToDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF15:" + ex.Message;
            }
        }
        #endregion
        #region Navigation
        ...
        private void txtFromDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF16:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txttoDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF17:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "CF18:" + ex.Message;
            }
        }
        /// <summary>
