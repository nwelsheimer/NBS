...
namespace Open_Miracle
{
    public partial class frmFundFlow : Form
    {
        ...
        public DataTable GetDataTable()
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF1:" + ex.Message;
            }
            return dtblFundFlow;
        }
        /// <summary>
        ...
        public DataTable GetDatagrid2()
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF2:" + ex.Message;
            }
        ...
        public void Print(DateTime fromDate, DateTime toDate)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF4:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void Clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF5:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF7:" + ex.Message;
            }
        }
        /// <summary>
        /// Form Load
        ...
        private void frmFundFlow_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF8:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF9:" + ex.Message;
            }
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF10:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpFundFlowFromDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF13:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpFundFlowToDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF14:" + ex.Message;
            }
        }
        /// <summary>
        /// DateValidation
        ...
        private void txtFundFlowFromDate_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF15:" + ex.Message;
            }
        }
        /// <summary>
        /// DateValidation
        ...
        private void txtFundflowToDate_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF16:" + ex.Message;
            }
        }
        #endregion
        #region Navigation
        ...
        private void frmFundFlow_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF17:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtFundFlowFromDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF18:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtFundflowToDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF19:" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and Backspace navigation
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF20:" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and Backspace navigation
        ...
        private void btnClear_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF21:" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and Backspace navigation
        ...
        private void dgvFundFlow_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF22:" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and Backspace navigation
        ...
        private void dgvFundFlow2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "FF23:" + ex.Message;
            }
        }
        #endregion
    }
