...
namespace Open_Miracle
{
    public partial class frmTrialBalance : Form
    {
        ...
        public void SlNo()
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB3:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnclear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB8:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvTrailBalance_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB11:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmTrialBalance_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB17:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtTodate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB18:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtFromDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "TB19:" + ex.Message;
            }
        }
        #endregion
    }
