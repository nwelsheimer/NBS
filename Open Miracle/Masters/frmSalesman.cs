...
namespace Open_Miracle
{
    public partial class frmSalesman : Form
    {
        ...
        public void Clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "S2" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ClearSearch()
        {
            ...
            {
                formMDI.infoError.ErrorString = "S4" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void Delete()
        {
            ...
            {
                formMDI.infoError.ErrorString = "S9" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromServiceVoucher(frmServiceVoucher frmServiceVoucherObjfromServiceVoucher)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S10" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromSalesOrder(frmSalesOrder frmSalesOrder)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S11" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromRejectionIn(frmRejectionIn frmrejectionin)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S12" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromSalesQuotation(frmSalesQuotation frmSalesQuotaion)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S13" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromDeliveryNote(frmDeliveryNote frmDeliveryNoteObj)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S14" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromSalesReturn(frmSalesReturn frmSalesReturn)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S15" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void callFromSalesInvoice(frmSalesInvoice frmSalesInvoice)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S16" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void callFromPOS(frmPOS frmPOS)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S17" + ex.Message;
            }
        }
        #endregion
        #region Events
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S18" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S19" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S20" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S21" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClearSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S22" + ex.Message;
            }
        }
        /// <summary>
        /// 
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S23" + ex.Message;
            }
        }
        /// <summary>
        /// On load 
        ...
        private void frmSalesman_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S24" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmSalesman_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S26" + ex.Message;
            }
        ...
        private void txtSalesmanCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S27" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtName_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S28" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtEmail_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S29" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtPhone_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S30" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtMobile_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S31" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtAddress_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S32" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtNarration_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S33" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSave_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S34" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S35" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnDelete_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S36" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClose_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S37" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S38" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtNameSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S39" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtMobileSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S40" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtPhoneSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S41" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbIsActive_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S42" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S43" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtAddress_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S44" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtNarration_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S45" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesman_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S46" + ex.Message;
            }
        }
        /// <summary>
        /// For shortcut keys
        ...
        private void frmSalesman_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S47" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesman_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S48" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cbxActive_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "S49" + ex.Message;
            }
        }
        #endregion

        private void gbxSalesMan_Enter(object sender, EventArgs e)
        {
