...
namespace Open_Miracle
{
    public partial class frmmultipleAccountLedger : Form
    {
        ...
        public void SlNo()
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL2:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CheckInvalidEntries(DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL3:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public bool RemoveIncompleteRowsFromGrid()
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL4:" + ex.Message;
        ...
        public bool CheckAlreadyExist()
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL5:" + ex.Message;
        ...
        public void SaveFunction()
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL6:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public bool ledgerSameOccourance()
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL8:" + ex.Message;
            }
        ...
        public void RemoveFunction()
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "MAL9:" + ex.Message;
            }
        }
        ...
        private void frmmultipleAccountLedger_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL10:" + ex.Message;
            }
        }
        /// <summary>
        /// Serial no in grid
        ...
        private void dgvMultipleAccountLedger_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL11:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL13:" + ex.Message;
            }
        }
        /// <summary>
        /// close button click
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL14:" + ex.Message;
            }
        }
        /// <summary>
        /// save button click
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL15:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvMultipleAccountLedger_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL16:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void lnklblRemove_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL18:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvMultipleAccountLedger_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL19:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvMultipleAccountLedger_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL20:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvMultipleAccountLedger_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL21:" + ex.Message;
            }
        }
        #endregion
        ...
        private void frmmultipleAccountLedger_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL22:" + ex.Message;
            }
        }
        /// <summary>
        /// save button keydown
        ...
        private void btnSave_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL23:" + ex.Message;
            }
        }
        /// <summary>
        /// grid keydown
        ...
        private void dgvMultipleAccountLedger_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL24:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbAccountGroup_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL25:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbAccountGroup_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "MAL26:" + ex.Message;
            }
        }
        #endregion
    }
