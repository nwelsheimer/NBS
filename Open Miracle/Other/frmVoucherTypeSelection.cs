...
namespace Open_Miracle
{
    public partial class frmVoucherTypeSelection : Form
    {
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS2:" + ex.Message;
            }
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS3:" + ex.Message;
            }
        ...
        private void frmVoucherTypeSelection_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS4:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbVoucherType_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS5:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnGo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS6:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmVoucherTypeSelection_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "VTS7:" + ex.Message;
            }
        }
