...
namespace Open_Miracle
{
    public partial class frmHolydaySettings : Form
    {
        ...
        public void CalenderFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO1:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void Clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO2:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void dgvHolidayRegisterFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO3:" + ex.Message;
            }
        }
        /// <summary>
        /// Function for save
        ...
        public void SaveFunction()
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO4:" + ex.Message;
            }
        }
        #endregion
       ...
       /// <param name="e"></param>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO6:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO7:" + ex.Message;
            }
        }
        /// <summary>
        /// Load
        ...
        private void frmHolydaySettings_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO8:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpMonth_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO9:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvCalender_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO10:" + ex.Message;
            }
        }
        /// <summary>
        /// Clears selection 
        ...
        private void dgvCalender_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO11:" + ex.Message;
            }
        }
        /// <summary>
        /// Clears selection 
        ...
        private void dgvHolidayRegister_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO12:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvCalender_CellMouseEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO13:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvCalender_CellMouseLeave(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO14:" + ex.Message;
            }
        }
        ...
        private void btnSave_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO15:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpYear_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO16:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpMonth_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO17:" + ex.Message;
            }
        }
        ...
        private void frmHolydaySettings_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "HO18:" + ex.Message;
            }
        }
        #endregion
    }
