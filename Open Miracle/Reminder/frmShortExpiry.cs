...
namespace Open_Miracle
{
    public partial class frmShortExpiry : Form
    {
        ...
        public void clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:1" + ex.Message;
            }
        }
        ...
        public void BrandComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:3" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ModelNoComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:5" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GroupComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:6" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GodownComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:7" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SizeComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:8" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ProductNameComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:9" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmShortExpiry_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:12" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnclose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:13" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:14" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:15" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmShortExpiry_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:16" + ex.Message;
            }
        }
        #endregion
        #region Navigations
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:17" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        private void cmbProduct_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:18" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:19" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:20" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:21" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:22" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:23" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "SE:24" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        private void frmShortExpiry_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SE:25" + ex.Message;
            }
        }
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Back)
            {
             ...
             {
                 formMDI.infoError.ErrorString = "SE:26" + ex.Message;
             }
        }
        #endregion
    }
