...
namespace Open_Miracle
{
    public partial class frmStock : Form
    {
        ...
        public void BrandComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:1" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TaxComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:2" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ModelNoComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:3" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GroupComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:4" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GodownComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:5" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SizeComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:6" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ProductNameComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:7" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void RackComboFillForLoad()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:9" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:10" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromNegativeStockReminder(frmReminderPopUp frmReminder, bool isFromNegativeStock)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:12" + ex.Message;
            }
        }
        /// <summary>
        /// Function to call this form from frmReminderPopUp to view details
        ...
        public void CallFromMinStockReminder(frmReminderPopUp frmReminder, bool isFromMinStock)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:13" + ex.Message;
            }
        }
        /// <summary>
        /// Function to call this form from frmReminderPopUp to view details
        ...
        public void CallFromMaxStockReminder(frmReminderPopUp frmReminder, bool isFromMaxStock)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:14" + ex.Message;
            }
        }
        /// <summary>
        /// Function to call this form from frmReminderPopUp to view details
        ...
        private void frmStock_Load(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:16" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:17" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:18" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:19" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbGodown_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:20" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmStock_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:21" + ex.Message;
            }
        }
        #endregion
        #region Navigation
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "ST:22" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        private void cmbProduct_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:23" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void cmbBrand_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:24" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        {
            {
                ...
                {
                    formMDI.infoError.ErrorString = "ST:25" + ex.Message;
                }
            }
        }
        /// <summary>
        ...
        private void cmbModelNo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:26" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void cmbTax_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:27" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void cmbGodown_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:28" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void cmbRack_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:29" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void btnReset_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:30" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void rbtnAll_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:31" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmStock_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:32" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void rbtnNegativestock_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:33" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void rbtnMin_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:34" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void rbtnReorder_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:35" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void rbtnMax_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:36" + ex.Message;
            }
        }
        /// <summary>
        /// Enter key and backspace navigation
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "ST:37" + ex.Message;
            }
        }
        #endregion
    }
