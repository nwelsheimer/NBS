...
namespace Open_Miracle
{
    public partial class frmVoucherWiseProductSearch : Form
    {
        ...
        /// </summary>
        TransactionsGeneralFill objtransactiongeneralfill = new TransactionsGeneralFill();
        ...
        public void FillProductGroup()
        {
            ...
            {
                formMDI.infoError.ErrorString = "VPS :1" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void VoucherTypeFill()
        {
            try
            {
                ...
                dtblVoucher = spVoucher.VoucherWiseProductSearchCombofill();
                DataRow dr = dtblVoucher.NewRow();
                dr["voucherTypeId"] = 0;
                dr["voucherTypeName"] = "All";
                dtblVoucher.Rows.InsertAt(dr, 0);
            ...
            {
                formMDI.infoError.ErrorString = "VPS :2" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SerialNo()
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :3" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmVoucherWiseProductSearch_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :6" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :7" + ex.Message;
            }
        }
        ...
        private void cmbVoucherType_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :8" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpFromDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :9" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dtpToDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :10" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvVoucherwiseProductSearch_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :11" + ex.Message;
            }
        ...
        private void btnViewDetails_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :12" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvVoucherwiseProductSearch_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :13" + ex.Message;
            }
        }
        /// <summary>
        /// Reset the form 
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :14" + ex.Message;
            }
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :15" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtFromDate_Leave(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :16" + ex.Message;
            }
        ...
        private void txtFromDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :18" + ex.Message;
            }
        ...
        private void txtToDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :19" + ex.Message;
            }
        }
        /// <summary>
        /// For enter key and BackSpace Navigation
        ...
        private void cmbVoucherType_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :20" + ex.Message;
            }
        ...
        private void txtVoucherNo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :21" + ex.Message;
            }
        ...
        private void cmbCashOrParty_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :22" + ex.Message;
            }
        ...
        private void cmbProductGroup_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :23" + ex.Message;
            }
        ...
        private void txtProductCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :24" + ex.Message;
            }
        ...
        private void txtProductName_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :25" + ex.Message;
            }
        ...
        private void btnSearch_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :26" + ex.Message;
            }
        ...
        private void btnReset_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                formMDI.infoError.ErrorString = "VPS :27" + ex.Message;
            }
