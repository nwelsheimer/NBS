...
namespace Open_Miracle
{
    public partial class frmSalesReturn : Form
    {
        ...
        DataTable dtblsalesinvoiceagainst = new DataTable();
        int inIndex = 0;
        ...
        DataTable dtblSalesReturnMasterViewBySMID = new DataTable();
        ...
        public void UnitConversionCalc(int inIndexOfRow)
        {
            try
            {
                ...
                {
                    dtblUnitByProduct = SpUnitConvertion.UnitConversionIdAndConRateViewallByProductId(dgvSalesReturn.Rows[inIndexOfRow].Cells["productId"].Value.ToString()
            ...
            try
            {
                ...
                if (inRowcount <= 2)
                {
                    if (dgvSalesReturn.Rows[0].Cells["dgvTextProductName"].Value == null || dgvSalesReturn.Rows[0].Cells["dgvTextProductName"].Value.ToString() == string.Empty ||
                        ...
                        (spSettings.SettingsStatusCheck("AllowZeroValueEntry") == "No" && Convert.ToDecimal(dgvSalesReturn.CurrentRow.Cells["dgvTextRate"].Value) == 0))
                    {
        ...
        public void CallFromVoucherTypeSelection(decimal decVoucherTypeId, string strVoucherTypeName)
        {
            try
            {
                ...
                infoSuffixPrefix = spSuffisprefix.GetSuffixPrefixDetails(decSalesReturnVoucherTypeId, dtpDate.Value);
        ...
        public void getProductRate(int index, decimal decProductId, decimal decBatchId)
        {
            ...
            try
            {
                ...
                decRateForPricingLevel = spProdut.SalesInvoiceProductRateForSales(decProductId, dtcurrentDate, decBatchId, decPricingLevelId, decNodecplaces);
            ...
            try
            {
                ...
                if (inRowCount > 1)
                {
                    ...
                    if (isNegativeLedger)
                    {
                        if (strStatus == "Warn")
                        {
                            if (MessageBox.Show("Negative Stock balance exists,Do you want to Continue", "Openmiracle", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                            {
                                isOk = true;
                            }
                        }
                        ...
                        {
                            MessageBox.Show("Cannot continue ,due to negative stock balance", "Openmiracle", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                            isOk = false;
                        }
                        else
                        {
        ...
        public void CallPriceListPopUp(frmPriceListPopup frmPriceListPopup, decimal decId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR17:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SaveOrEdit()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR18:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TotalBillTaxCalculation()
        {
            try
            {
                ...
                dtbl = spTax.TotalBillTaxCalculationBtapplicableOn();
                foreach (DataRow drowItem in dtbl.Rows)
                {
                    if (drowItem != null)
                    {
            ...
            {
                formMDI.infoError.ErrorString = "SR19:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CheckInvalidEntries(DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                if (dgvSalesReturn.CurrentRow != null)
                {
                    ...
                    //else if (dgvSalesReturn.CurrentRow.Cells["dgvTextRate"].Value == null || dgvSalesReturn.CurrentRow.Cells["dgvTextRate"].Value.ToString().Trim() == "" )
                    //{
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Value = "X";
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Style.ForeColor = Color.Red;
                    //}
                    //else if (dgvSalesReturn.CurrentRow.Cells["dgvTextGrossValue"].Value == null || dgvSalesReturn.CurrentRow.Cells["dgvTextGrossValue"].Value.ToString().Trim() == "")
                    //{
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Value = "X";
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Style.ForeColor = Color.Red;
                    //}
                    //else if (dgvSalesReturn.CurrentRow.Cells["dgvTextAmount1"].Value == null || dgvSalesReturn.CurrentRow.Cells["dgvTextAmount1"].Value.ToString().Trim() == "")
                    //{
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Value = "X";
                    //    dgvSalesReturn.CurrentRow.HeaderCell.Style.ForeColor = Color.Red;
                    //}
                    else if (spSettings.SettingsStatusCheck("AllowZeroValueEntry") == "No" && Convert.ToDecimal(dgvSalesReturn.CurrentRow.Cells["dgvTextRate"].Value) == 0)
                    {
                        dgvSalesReturn.CurrentRow.HeaderCell.Value = "X";
                        dgvSalesReturn.CurrentRow.HeaderCell.Style.ForeColor = Color.Red;
                    }
            ...
            {
                formMDI.infoError.ErrorString = "SR20:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public bool PrintAfetrSave()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR21:" + ex.Message;
            }
            return isTick;
        }
        /// <summary>
        ...
        public void clear()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR22:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromVoucherSearch(frmVoucherSearch frm, decimal decId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR23:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromProductSearchPopup(frmProductSearchPopup frmProductSearchPopup, decimal decproductId, decimal decCurrentRowIndex)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR24:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromSalesReturnRegister(frmSalesReturnRegister objSalesReturnRegister, decimal decSalesReturnMasterId, bool isFromRegister, bool isSalesReturnActive)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR25:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromSalesReturnReport(frmSalesReturnReport objSalesReturnReport, decimal decSalesReturnMasterId, bool isFromReport, bool isSalesReturnActive)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR26:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void UnitComboFill(decimal decProductId, int inRow, int inColumn)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR27:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void FillRegisterOrReport()
        {
                    ...
                    foreach (DataRow drowDetails in dtblSalesReturnDetails.Rows)
                    {
                        ...
                        if (drowDetails["productId"].ToString() != string.Empty)
                        {
                            ...
                            foreach (DataRow drowDetails1 in dtbl.Rows)
                            {
                                ...
                                {
                                    RackAllComboFill(dgvSalesReturn.Rows.Count - 2);
            ...
            {
                formMDI.infoError.ErrorString = "SR28:" + ex.Message;
            }
        }
        /// <summary>
        /// Function to clear the contro,ls while updating
        /// </summary>
        public void ClearToCallFromSaesReturnRegister()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR29:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void Delete()
        {
            ...
            {
                SalesReturnMasterSP spSalesReturnMaster = new SalesReturnMasterSP();
                spSalesReturnMaster.SalesReturnDelete(salesReturnMasterId, decSalesReturnVoucherTypeId, strVoucherNo);
            ...
            {
                formMDI.infoError.ErrorString = "SR30:" + ex.Message;
            }
        }
        /// <summary>
        /// print function
        ...
        public void Print(decimal decSalesReturnMasterId)
        {
            ...
            {
                SalesReturnMasterSP spSalesReturnMaster = new SalesReturnMasterSP();
                DataSet dsSalesReturn = spSalesReturnMaster.SalesReturnPrinting(decSalesReturnMasterId);
            ...
            {
                formMDI.infoError.ErrorString = "SR31:" + ex.Message;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="decSalesReturnMasterId"></param>
        public void PrintForDotMatrix(decimal decSalesReturnMasterId)//used by safiyy
        {
            try
            {
                ...
                VoucherTypeSP spVoucherType = new VoucherTypeSP();
                DataTable dtblDeclaration = spVoucherType.DeclarationAndHeadingGetByVoucherTypeId(decSalesReturnVoucherTypeId);
            ...
            {
                formMDI.infoError.ErrorString = "SR32:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void RemoveFunction()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR33:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public bool ProductSameOccourance()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR34:" + ex.Message;
            }
            return isSame;
        }
        /// <summary>
        ...
        public void CalculateTAmt()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR35:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void Save()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR36:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GrandTotalCalculation()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR37:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public decimal TotalNetAmountForLedgerPosting()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR38:" + ex.Message;
            }
            return decNetAmount;
        }
        /// <summary>
        ...
        public void SerialNo()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR39:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TotalTaxAmtCalculation()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR40:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TotalAmtCalculation()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR41:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TotalAmountCalculationForSaveOrEdit()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR42:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SerialNo2()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR43:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ReturnFromAccountLedger(decimal decAccountLedgerId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR44:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ReturnFromAccountLedgerOfSalesAccount(decimal decAccountLedgerId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR45:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ComboSelectionByInvoiceNo()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR46:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DiscountCalculation(int inRowIndex, int inColumnIndex)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR47:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DiscountCalculationfordiscountpercentage(int inRowIndex, int inColumnIndex)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR48:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TaxAmountCalculation(int inRowIndex)
        {
            ...
            try
            {
                ...
                {
                    TaxInfo InfoTaxMaster = SpTax.TaxView(Convert.ToDecimal(dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbTax"].Value.ToString()));
            ...
            {
                formMDI.infoError.ErrorString = "SR49:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void GrossValueCalculation(int inRowIndex)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR50:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ReturnFromPricingLevel(decimal decPricingLevelId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR51:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void ReturnFromSalesMan(decimal decSalesManId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR52:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CashOrPartyUnderSundryDebitorComboFill(ComboBox cmbCashOrParty)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR53:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SalesAccountComboFill(ComboBox cmbSalesAccount)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR54:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SalesReturnInvoiceNoComboFill(decimal decVoucherTypeId, decimal salesReturnMasterId, decimal decledgerId)
        {
            try
            {
                ...
                DataTable dtbl = new DataTable();
                dtbl = salesReturnMasterSP.SalesReturnInvoiceNoComboFill(decVoucherTypeId, salesReturnMasterId, decledgerId);
            ...
            {
                formMDI.infoError.ErrorString = "SR55:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SalesReturnVoucherTypeComboFill(decimal ledgerIdFromCashOrPartyCombo)
        {
            try
            {
                SalesReturnMasterSP salesReturnMasterSP = new SalesReturnMasterSP();
                DataTable dtbl = new DataTable();
                dtbl = salesReturnMasterSP.SalesReturnVoucherTypeComboFill(ledgerIdFromCashOrPartyCombo);
            ...
            {
                formMDI.infoError.ErrorString = "SR56:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void PrlicingLevelComboFill(ComboBox cmbPricingLevel)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR57:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DGVUnitComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR58:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DGVGodownComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR59:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DGVCurrencyComboFill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR60:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void RackComboFill(decimal decGodownId, int inRow, int inColumn)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR61:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void BatchComboFill(decimal decProductId, int inRow, int inColumn)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR62:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void DGVTaxComboFill()
        {
            try
            {
                ...
                dgvCmbTax.DataSource = dtblTax;
                dgvCmbTax.ValueMember = "taxId";
                dgvCmbTax.DisplayMember = "taxName";
            }
            catch (Exception ex)
            {
                formMDI.infoError.ErrorString = "SR63:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TaxGridFill()
        {
            ...
            try
            {
                ...
                dtbl = spTax.TaxViewAllByVoucherTypeId1(decSalesReturnVoucherTypeId, strTaxApplicableOn);
            ...
            {
                formMDI.infoError.ErrorString = "SR64:" + ex.Message;
            }
        }
        /// <summary>
        /// Function to use the tax gridfill
        ...
        public void DGVSalesReturn2Fill()
        {
            try
            {
                DataTable dtblSalesReturn2GrideFill = new DataTable();
                TaxSP spTax = new TaxSP();
                dtblSalesReturn2GrideFill = spTax.TaxViewAllByVoucherTypeIdWithCess(decSalesReturnVoucherTypeId);
                dgvSalesReturn2.Rows.Clear();
                foreach (DataRow drowDetails in dtblSalesReturn2GrideFill.Rows)
                {
                    dgvSalesReturn2.Rows.Add();
            ...
            {
                formMDI.infoError.ErrorString = "SR65:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CessTaxamountCalculation()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR66:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void VoucherTypeCombofill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR67:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void SalesManComboFill(ComboBox cmbSalesMan)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR68:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void VoucherNumberGeneration()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR69:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void callFromAgeing(frmAgeingReport frmAgeing, decimal decMasterId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR70:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void CallFromLedgerDetails(frmLedgerDetails frmLedgerDetails, decimal decMasterId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR71:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void callFromDayBook(frmDayBook frmDayBook, decimal decMasterId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR72:" + ex.Message;
            }
        }
        /// <summary>
        /// Rackcombofill
        ...
        public void rackcombofill1(decimal decrackId)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR73:" + ex.Message;
            }
        }
        public void RackAllComboFill(int inRow)
        {
            try
            {
                ...
                DataGridViewComboBoxCell dgvcmbRackCell = (DataGridViewComboBoxCell)dgvSalesReturn.Rows[inRow].Cells["dgvCmbRack"];
                dgvcmbRackCell.DataSource = dtbl;
                dgvcmbRackCell.ValueMember = "rackId";
                dgvcmbRackCell.DisplayMember = "rackName";
            }
        ...
        public void ProductDetailsFill(string strProduct, int inRowIndex, string strFillMode)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR74:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void taxAndGridTotalAmountCalculation(int inIndexOfRow)
        {
            ...
            try
            {
                ...
                if (dgvSalesReturn.Rows[inIndexOfRow].Cells["dgvTextQty"].Value != null && dgvSalesReturn.Rows[inIndexOfRow].Cells["dgvTextQty"].Value.ToString() != string.Empty)
                {
                    ...
                    {
                        TaxInfo InfoTaxMaster = SpTax.TaxView(Convert.ToDecimal(dgvSalesReturn.Rows[inIndexOfRow].Cells["dgvCmbTax"].Value.ToString()));
            ...
            {
                formMDI.infoError.ErrorString = "SR75:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void taxamountfill()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR76:" + ex.Message;
            }
        }
        /// <summary>
        ...
        public void TotalAmountCalculation()
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR77:" + ex.Message;
            }
        }
        #endregion
        #region Events
        ...
        private void txtDate_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR78:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmSalesReturn_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Spsetting.SettingsStatusCheck("Tax") == "Yes")
                {
                ...
                if (Spsetting.SettingsStatusCheck("ShowDiscountPercentage") == "Yes")
                {
                ...
                if (Spsetting.SettingsStatusCheck("ShowDiscountAmount") == "Yes")
                {
                    dgvSalesReturn.Columns["dgvTextDiscountAmount"].Visible = true;
                    dgvSalesReturn.Columns["dgvTextDiscountPercentage"].Visible = true;
                }
            ...
            {
                formMDI.infoError.ErrorString = "SR79:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmSalesReturn_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR80:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbInvoiceNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR81:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesReturn_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR82:" + ex.Message;
            }
        }
        ...
        private void dtpDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR83:" + ex.Message;
            }
        }
        /// <summary>
        ...
        void comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR84:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtTotalAmount_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR85:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtBillDiscount_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR86:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtBillDiscount_Leave(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR87:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbVoucherType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR88:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesReturn_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR89:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void cmbPricingLevel_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR90:" + ex.Message;
            }
        }
        /// <summary>
        /// Close button click
        ...
        private void btnSalesReturnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR91:" + ex.Message;
            }
        }
        /// <summary>
        ...
        void TextBoxControl_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR92:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesReturn_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR93:" + ex.Message;
            }
        }
        /// <summary>
        /// Delete button click
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR94:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void txtBillDiscount_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR95:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnCashOrParty_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR96:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnPricingLevel_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR97:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSalesMan_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR98:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSalesAcct_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR99:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR100:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void lnklblRemove_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR101:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR102:" + ex.Message;
            }
        }
        private void dgvSalesReturn_EditingControlShowing_1(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR103:" + ex.Message;
            }
        }
        private void cmbCashOrParty_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR104:" + ex.Message;
            }
        }
        private void dgvSalesReturn_RowsAdded(object sender, DataGridViewRowsAddedEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR105:" + ex.Message;
            }
        }
        private void txtBillDiscount_Enter(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR106:" + ex.Message;
            }
        }
        #endregion
        #region Navigation
        ...
        private void cmbCashOrParty_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR107:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbCurrency_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR108:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtTransportationComp_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR109:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtReturnNo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR110:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtLRNo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR111:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtNarration_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR112:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtBillDiscount_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR113:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbInvoiceNo_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR114:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbPricingLevel_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR115:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbSalesAccount_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR116:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbSalesMan_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR117:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void txtDate_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR118:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void dgvSalesReturn_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR119:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void frmSalesReturn_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR120:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void cmbVoucherType_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR121:" + ex.Message;
            }
        }
        /// <summary>
        /// For enterkey and backspace navigation
        ...
        private void btnSave_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR122:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesReturn_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
                    ...
                    if (dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value != null && dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value.ToString() != string.Empty)
                    {
                        if (decimal.Parse(dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value.ToString()) > 0)
                        {
                            if (dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value != null && dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value.ToString() != string.Empty)
                            {
                                ...
                                dtblSalesReturnGrideFill = spSalesDetails.SalesDetailsViewForSalesReturnGrideFill(Convert.ToDecimal(cmbInvoiceNo.SelectedValue.ToString()), salesReturnMasterId);
                                if (decimal.Parse(dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value.ToString()) > decimal.Parse(dtblSalesReturnGrideFill.Rows[e.RowIndex]["qty"].ToString()))
                                {
                                    dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value = Math.Round(Convert.ToDecimal(dtblSalesReturnGrideFill.Rows[e.RowIndex]["qty"].ToString()), PublicVariables._inNoOfDecimalPlaces);
                                }
                            }
                        }
                    }
            ...
            {
                formMDI.infoError.ErrorString = "SR123:" + ex.Message;
            }
        }
        /// <summary>
        ...
        private void dgvSalesReturn_CurrentCellDirtyStateChanged(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "SR124:" + ex.Message;
            }
        }
        #endregion
    }
