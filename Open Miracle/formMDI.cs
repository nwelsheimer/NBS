...
namespace Open_Miracle
{
    public partial class formMDI : Form
    {
        ...
        myLabel lblMiracleI = new myLabel();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void lblMiracleI_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void contentsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("hh.exe", Application.StartupPath + "\\Openmiracle.chm");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// On ToolStripMenuItem miracleSkateToolStripMenuItem Click
        /// Calls miracleSkate
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void miracleSkateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Process.GetProcessesByName("MiracleSkate").Length == 0)
                {
                    ...
                    {
                        FileName = "MiracleSkate.EXE"
                    });
                }
                else
                {
                    MessageBox.Show("Miracle Skate is opend.!", "Openmiracle", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// On ToolStripMenuItem miracleIToolStripMenuItem Click
        /// Calls miracleI
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void miracleIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Process.GetProcessesByName("MiracleI").Length == 0)
                {
                    Process.Start(new ProcessStartInfo()
                    {
                        FileName = "MiracleI.EXE"
                    });
                }
                else
                {

                    MessageBox.Show("MiracleI is opend.!", "Openmiracle", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
    ...
    private void sitesToolStripMenuItem_Click(object sender, EventArgs e)
    {
      try
      {
        frmSites frm = new frmSites();
        frmSites open = Application.OpenForms["frmSites"] as frmSites;
        if (open == null)
        {
          frm.MdiParent = this;
          frm.Show();
      ...
      {
        infoError.ErrorString = "CE2001:" + ex.Message;
      }
    }
  }
}
