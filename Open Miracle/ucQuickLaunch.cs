...
{
    public partial class ucQuickLaunch : UserControl
    {
        #region Variables
        #endregion
        #region Functions
        /// <summary>
        /// create an instance of ucQuickLaunch class
        /// </summary>
        ...
        /// <summary>
        /// Function for get the customized details
        /// </summary>
        ...
        /// <summary>
        /// Function for assigning buttons text's
        /// </summary>
        ...
        #region Events
        /// <summary>
        /// On UserControl ucQuickLaunch Load
        /// </summary>
        ...
        /// <summary>
        /// On Button btnCustomizeMenu Click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnCustomizeMenu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (open == null)
                {
                    ...
                    objMenuCustomization.MdiParent = formMDI.ActiveForm;
        ...
        private void label2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                formMDI.infoError.ErrorString = "QUICK 4" + ex.Message;
            }
        }
    }
}
